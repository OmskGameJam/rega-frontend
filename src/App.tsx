      ...
      <main>
        ...
        <section>
          ...
          <h1 className='text-outline d-box'>
            Омский Людум Даре 5-6 октября!
          </h1>
          <div className='d-box'>
            <p>
              <b><span>Игровое варенье</span></b> - это омский хакатон по разработке ИГР.<br/>
              Собираемся 5 октября в 10:00 в Точке Кипения на Жукова 21 в городе Омске и пишем игру ДВА ДНЯ.
            </p>
            <p>
              Стартуем одновременно с <a target='_blank' href="https://ldjam.com/">Ludum Dare #56!</a><br/>
              <br />
              Ludum Dare — это мировой конкурс по созданию игр за 48 часов. Разработчики, дизайнеры и просто весёлые ребята со всего мира создают новые игры на тему, выбранную общим голосованием.<br />
