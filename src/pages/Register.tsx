...
export function Register() {
  ...
  <section>
    ...
    <RadioGroup
      ...
      options={[
        { long: 'С нами, из ИТ-парка на Комарова 21 к1', short: 'Из ИТ-парка' }, 
    ...
    <CheckboxGroup
      ...
      options={[
        { short: 'public', long: 'Анонсировать регистрацию в чат Омского Геймдева и показывать мою команду в списке участников'},
