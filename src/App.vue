...
<template>
  <Typography>
    <main>
      ...
      <section>
        <div class="ras">
          <Window title="Суббота, 18 апреля" faux :extra-styles="{ gridArea: '1 / 1 / 2 / 2' }">
            <ul>
          ...
          <Window title="Воскресенье, 19 апреля" faux :extra-styles="{ gridArea: '1 / 2 / 2 / 3' }">
            <ul>
              <li>Открытие в 10:00</li>
              <li>Делаем игры</li>
              <li>
          ...
          <Window faux title="Геолокация" :extra-styles="{ gridArea: '2 / 1 / 3 / 3' }">
