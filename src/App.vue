...
<template>
  <main>
    ...
    <section>
      <div class="ras">
        <Box type="panel-d-1" :extra-styles="{ gridArea: '1 / 1 / 2 / 2' }">
        ...
        <Box type="panel-d-1" :extra-styles="{ gridArea: '1 / 2 / 2 / 3' }">
        ...
        <Box type="panel-d-1" :extra-styles="{ gridArea: '2 / 1 / 3 / 3' }">
          <div>
        ...
        <Box type="panel-d-1" :extra-styles="{ gridArea: '3 / 1 / 3 / 3' }">
